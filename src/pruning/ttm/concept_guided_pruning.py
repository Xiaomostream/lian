...
class ConceptGuidedPruning:
    ...
    def __init__(
        self,
        concept_map_path: str = './concept_maps/ttm_concept_map.pkl',
    ...
    def analyze_importance_distribution(self, module_importance):
        ...
        ax1.set_title('TTM Module Importance Distribution', fontsize=14)
        ax1.grid(alpha=0.3)
        ...
        save_path = './visualizations/ttm_importance_distribution.pdf'
        Path(save_path).parent.mkdir(parents=True, exist_ok=True)
