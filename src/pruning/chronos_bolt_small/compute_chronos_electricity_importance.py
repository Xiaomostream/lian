"""
计算Chronos在Electricity上的概念重要性
复用Chronos的概念映射，使用Electricity的任务向量
"""
...
if __name__ == '__main__':
    print("="*60)
    print("Chronos + Electricity 概念重要性计算")
    print("="*60)
    ...
    pruner.save_importance(
        module_importance,
        save_path='./pruning_importance/Chronos_bolt_small/chronos_electricity_importance.pkl'
    )
    ...
    print("\n" + "="*60)
    print("✓ Chronos + Electricity 概念重要性计算完成!")
    print("="*60)
