...
class ConceptGuidedPruning:
    ...
    def __init__(
        self,
        concept_map_path: str = './concept_maps/chronos_small_concept_map.pkl',
    ...
    def save_importance(
        ...
        save_path: str = './pruning_importance/concept_guided_importance.pkl'
    ):
        """保存模块重要性"""
    ...
    def analyze_importance_distribution(
        ...
        ax1.set_title('Module Importance Distribution', fontsize=14)
        ax1.grid(alpha=0.3)
        ...
        save_path = './visualizations/importance_distribution.pdf'
        Path(save_path).parent.mkdir(parents=True, exist_ok=True)
