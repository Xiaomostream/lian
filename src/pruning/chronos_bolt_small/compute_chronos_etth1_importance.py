"""
计算Chronos在ETTh1上的概念重要性
复用Chronos的概念映射，使用ETTh1的任务向量
"""
...
if __name__ == '__main__':
    ...
    pruner.save_importance(
        module_importance,
        save_path='./pruning_importance/Chronos_bolt_small/chronos_etth1_importance.pkl'
    )
