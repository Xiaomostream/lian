"""
计算Chronos在ETTm1上的概念重要性
复用Chronos的概念映射，使用ETTm1的任务向量
"""
...
if __name__ == '__main__':
    ...
    pruner.save_importance(
        module_importance,
        save_path='./pruning_importance/Chronos_bolt_small/chronos_ettm1_importance.pkl'
    )
