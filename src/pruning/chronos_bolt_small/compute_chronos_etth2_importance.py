"""
计算Chronos在ETTh2上的概念重要性
复用Chronos的概念映射，使用ETTh2的任务向量
"""
...
if __name__ == '__main__':
    ...
    pruner = ConceptGuidedPruning(
        ...
        task_vector_path='./task_vectors/etth2_task_vector.pkl'
    )
    ...
    pruner.save_importance(
        module_importance,
        save_path='./pruning_importance/Chronos_bolt_small/chronos_etth2_importance.pkl'
    )
