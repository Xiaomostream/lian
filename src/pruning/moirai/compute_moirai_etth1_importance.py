...
if __name__ == '__main__':
    ...
    pruner.save_importance(module_importance, './pruning_importance/moirai/moirai_etth1_importance.pkl')
    pruner.analyze_importance_distribution(module_importance)
    print("\n✓ Moirai + ETTh1 概念重要性计算完成!")
