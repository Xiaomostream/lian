...
if __name__ == '__main__':
    ...
    pruner.save_importance(module_importance, './pruning_importance/moirai/moirai_ettm2_importance.pkl')
    pruner.analyze_importance_distribution(module_importance)
    print("\n✓ Moirai + ETTm2 概念重要性计算完成!")
