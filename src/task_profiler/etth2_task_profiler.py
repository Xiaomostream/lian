...
if __name__ == '__main__':
    print("="*60)
    print("ETTh2 任务概念向量计算")
    print("="*60)
    
    # 创建画像器，指定ETTh2数据
    profiler = ETTh1TaskProfiler(data_path='./datasets/ETT-small/ETTh2.csv')
    ...
    profiler.save_task_vector(
        task_vector, 
        save_path='./task_vectors/etth2_task_vector.pkl'
    )
