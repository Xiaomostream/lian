...
if __name__ == '__main__':
    print("="*60)
    print("Electricity 任务概念向量计算")
    print("="*60)
    
    # 创建画像器，指定Electricity数据
    profiler = ETTh1TaskProfiler(data_path='./datasets/Electricity/electricity.csv')
    ...
    # 显示结果
    print("\n" + "="*60)
    print("任务概念向量 Task[c] - Electricity")
    print("="*60)
    ...
    profiler.save_task_vector(
        task_vector, 
        save_path='./task_vectors/electricity_task_vector.pkl'
    )
