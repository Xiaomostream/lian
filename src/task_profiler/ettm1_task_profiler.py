...
if __name__ == '__main__':
    print("="*60)
    print("ETTm1 任务概念向量计算")
    print("="*60)
    
    # 创建画像器，指定ETTm1数据
    profiler = ETTh1TaskProfiler(data_path='./datasets/ETT-small/ETTm1.csv')
    ...
    profiler.save_task_vector(
        task_vector, 
        save_path='./task_vectors/ettm1_task_vector.pkl'
    )
